...
import { Deck } from "https://cdn.jsdelivr.net/npm/deck.gl@8.8.5/dist.min.js";
...
```js
const statistics_algo = FileAttachment("./data/clusters_statistics.json").json();
```

```js
const summary = {
  keys: Object.keys(statistics_algo), // Liste des clés de premier niveau
  example: statistics_algo[Object.keys(statistics_algo)[0]] // Un exemple de sous-entrée (pour une clé aléatoire)
};
// Afficher le résumé
console.log("Structure de statistics_algo : ", summary);
```
